...
if /i "%continue%"=="Y" (
    :: Begin cleanup script
   	::Begin reg changes
		...
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "Behavior" /t REG_DWORD /d 0x00102020 /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "highrange" /t REG_DWORD /d 0x00000001 /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "lowrange" /t REG_DWORD /d 0x00000000 /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "mergealgorithm" /t REG_DWORD /d 0x00000001 /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "policytype" /t REG_DWORD /d 0x00000004 /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "RegKeyPathRedirect" /t REG_SZ /d "Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Paint" /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "RegValueNameRedirect" /t REG_SZ /d "DisableImageCreator" /f
		reg add "HKLM\SOFTWARE\Microsoft\PolicyManager\default\WindowsAI\DisableImageCreator" /v "value" /t REG_DWORD /d 0x00000000 /f
		reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Paint" /v "DisableImageCreator" /t REG_DWORD /d 0x00000001 /f
...
::Brave Browser
	::Debloat
		...
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "TorDisabled" /t REG_DWORD /d 1 /f
		...
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "AllowDinosaurEasterEgg" /t REG_DWORD /d 0 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "CreateThemesSettings" /t REG_DWORD /d 2 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "DevToolsGenAiSettings" /t REG_DWORD /d 2 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "GenAILocalFoundationalModelSettings" /t REG_DWORD /d 1 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "HelpMeWriteSettings" /t REG_DWORD /d 2 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "HistorySearchSettings" /t REG_DWORD /d 2 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "PromotionalTabsEnabled" /t REG_DWORD /d 0 /f
		reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\BraveSoftware\Brave" /v "PromotionsEnabled" /t REG_DWORD /d 0 /f
::Office
